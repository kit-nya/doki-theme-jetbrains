...
object ThemeSettings {
  ...
  val CHANGELOG_URI =
    URI("https://github.com/kit-nya/doki-theme-jetbrains/blob/main/CHANGELOG.md")
  private const val REPOSITORY = "https://github.com/kit-nya/doki-theme-jetbrains"
  const val ULTIMATE_INSTRUCTIONS = "$REPOSITORY/wiki/Ultimate-Theme-Setup"
  val ISSUES_URI = URI("$REPOSITORY/issues")
  val REVIEW_URI = URI("https://plugins.jetbrains.com/plugin/30534-doki-theme-v2/reviews")
